...
var _align = __webpack_require__(38);
...
var _direction = __webpack_require__(40);

var _font = __webpack_require__(41);
...
var _spot = __webpack_require__(109);
...
SpotTheme.DEFAULTS = (0, _extend2.default)(true, {}, _base2.default.DEFAULTS, {
  modules: {
    toolbar: {
      handlers: {
        link: function link(value) {
...
var SpotTooltip = function (_BaseTooltip) {
  _inherits(SpotTooltip, _BaseTooltip);

  function SpotTooltip(quill, bounds) {
    _classCallCheck(this, SpotTooltip);

    var _this2 = _possibleConstructorReturn(this, (SpotTooltip.__proto__ || Object.getPrototypeOf(SpotTooltip)).call(this, quill, bounds));
  ...
  _createClass(SpotTooltip, [{
    ...
    value: function listen() {
      ...
      _get(SpotTooltip.prototype.__proto__ || Object.getPrototypeOf(SpotTooltip.prototype), 'listen', this).call(this);
      this.root.querySelector('a.ql-action').addEventListener('click', function (event) {
        if (_this3.root.classList.contains('ql-editing')) {
          _this3.save();
        } else {
    ...
    key: 'show',
    value: function show() {
      _get(SpotTooltip.prototype.__proto__ || Object.getPrototypeOf(SpotTooltip.prototype), 'show', this).call(this);
      this.root.removeAttribute('data-mode');
    }
  }]);
...
SpotTooltip.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join('');

exports.default = SpotTheme;
